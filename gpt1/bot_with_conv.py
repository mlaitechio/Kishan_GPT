...
def construct_prompt(question: str, context_embeddings: dict, df: pd.DataFrame) -> str:
    ...
    header = f"""You are a friendly, conversational ICICI bank assistant. Use the following context whats available urls, image urls,data, help find what they want, and answer any questions.
...
#     prompt="""Given the following chat history and a follow up question, 
...
#     {conv}
#     \"""
#     Please Note: If Customer Greet in response only give Greet don't make question of the greet.
#     Follow Up Input: \"""
#     {prompt}
#     \"""
    
#     Standalone question:""".format(prompt=prompt, conv=conv),max_tokens=50)
